...
if admin_pass == "1234":
    ...
    if opcion == "Agregar nuevo comercio":
        with st.form("add_form", clear_on_submit=True):
            ...
            enviado = st.form_submit_with_button("💾 Guardar en Planilla")
            if enviado:
        ...
        if len(df_actual) > 0:
            ...
            with st.form("edit_form"):
                ...
                with col_btn1:
                    actualizar = st.form_submit_with_button("🔄 Actualizar Datos")
                with col_btn2:
                    eliminar = st.form_submit_with_button("🗑️ Eliminar Comercio")
